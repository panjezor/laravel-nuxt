...
import nuxt_plugin_router_2fd8e1de from 'nuxt_plugin_router_2fd8e1de' // Source: ./router.js (mode: 'all')
...
async function createApp (ssrContext) {
  ...
  const app = {
    head: {"title":"Laravel Nuxt","titleTemplate":"%s - Laravel Nuxt","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Nuxt.js project"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_router_2fd8e1de === 'function') {
    await nuxt_plugin_router_2fd8e1de(app.context, inject)
  }
